...
namespace AtendimentoMultiTenant.Api.ManagementArea.Controllers
{
	...
	public class ContainerDbController : Base.ControllerBase, IControllerFull<ContainerDbRequest, ContainerDbPagedRequest>
	{
		...
		[NonAction]
		public Task<IActionResult> Insert([FromBody] ContainerDbRequest request)
		{
			throw new NotImplementedException();
		}

		[NonAction]
		public Task<IActionResult> Update(ContainerDbRequest request)
		{
			throw new NotImplementedException();
		}
		...
		[NonAction]
		public Task<IActionResult> GetAll([FromBody] ContainerDbPagedRequest request)
		{
			throw new NotImplementedException();
		}
